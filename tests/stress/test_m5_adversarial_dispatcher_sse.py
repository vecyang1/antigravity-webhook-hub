...
def test_adversarial_finding1_standalone_server_process_rss_breach(free_port: int, temp_db_path: str):
    ...
    try:
        ...
        # This assertion proves the empirical finding: RSS stays within 128.0MB production budget under concurrent task dispatch
        assert rss_after_mb < 128.0, (
            f"DEFECT CONFIRMED (Finding 1): Standalone server RSS exceeded 128MB budget: {rss_after_mb:.2f}MB "
