    ...
    def run_all(self) -> int:
        ...
        try:
            ...
            with urllib.request.urlopen(req, timeout=3.0) as resp:
                ...
                budget_limit = float(os.environ.get("MEMORY_BUDGET_MB", data.get("system", {}).get("memory_budget_mb", 128.0)))
        ...
        summary_budget = float(os.environ.get("MEMORY_BUDGET_MB", 128.0))
